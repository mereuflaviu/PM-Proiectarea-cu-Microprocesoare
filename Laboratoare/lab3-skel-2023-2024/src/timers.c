...
void Timer0_init_pwm()
{
    ...
    /* Set COM0B to inverting output mode: COM0B[1:0] = 0b11 */
    TCCR0A |= (1 << COM0A1) | (1 << COM0A0);
    
    /* Set prescaler to 64: CS0[2:0] = 0b011 */
...
void Timer2_init_systicks()
{
    ...
    TIMSK2 = (1 << OCIE2A) | (1 << OCIE2B); /* interrupt when counter reaches OCR2A == 188  & enable also COMPB*/
    OCR2B = 94;
...
ISR(TIMER2_COMPB_vect) { PORTD |= (1 << PD7); }// Setează PD7 pe 1 (LED off) }
